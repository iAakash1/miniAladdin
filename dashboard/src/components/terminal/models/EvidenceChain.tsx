...
export default function EvidenceChain() {
  ...
  const columns: DataColumn<LeaderboardRow>[] = useMemo(() => [
    ...
    { key: 'ic', header: 'Mean IC', unit: 'rank corr.', numeric: true, sort: (r) => r.mean_ic, render: (r) => <Value value={r.mean_ic} digits={4} signed tone /> },
    ...
    { key: 'dd', header: 'Max DD', unit: 'return', numeric: true, sort: (r) => r.max_drawdown, render: (r) => <Value value={r.max_drawdown} digits={3} tone /> },
