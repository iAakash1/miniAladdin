...
export default function RegimePerformance({
  ...
  const columns: DataColumn<RegimeRow>[] = useMemo(() => [
    ...
    { key: 't', header: 'IC t', unit: 'Newey-West', numeric: true, sort: (r) => n(r.ic_t_stat), render: (r) => <Value measure="ic_t_stat" kind="tstat" value={n(r.ic_t_stat)} digits={3} signed /> },
