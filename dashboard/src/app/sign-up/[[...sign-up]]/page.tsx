  ...
  return (
    <div style={{ minHeight:'100vh', background:'#060d1b', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', position:'relative' }}>
      ...
      <div style={{ position:'relative', zIndex:1 }}>
        <SignUp appearance={{ variables: { colorPrimary:'#38bdf8', colorBackground:'#0a1628', colorText:'#dde6f5', colorInputBackground:'#0d1e36', colorInputText:'#dde6f5', borderRadius:'7px', fontFamily:'JetBrains Mono, monospace' }, elements: { card:'border border-[rgba(56,189,248,0.15)] shadow-none', formButtonPrimary:'bg-[#38bdf8] text-[#060d1b] hover:bg-[#7dd3fc] font-bold', footerActionLink:'text-[#38bdf8]' } }} />
      </div>
    </div>
  )
}
