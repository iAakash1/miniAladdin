...
export const DESTINATIONS: DestinationGroup[] = [
  {
    group: 'Observe',
    items: [
      { href: '/terminal/command', label: 'Command', glyph: '⌘', key: 'c', answers: 'what deserves attention right now' },
      { href: '/terminal/market', label: 'Market', glyph: 'M', key: 'j', answers: 'what is happening, before any ticker is typed' },
      { href: '/terminal/security', label: 'Securities', glyph: 'T', key: 's', answers: 'one name, and our record against it' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/terminal/portfolio', label: 'Watchlists', glyph: 'W', key: 'z', answers: 'what you are following' },
    ],
  },
  {
    group: 'Verify',
